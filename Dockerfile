FROM ubuntu:latest
LABEL Description="Docker image for NS-3 with 5G-LENA and QUIC modules"
...
#RUN git clone -b ns-3.32 https://gitlab.com/nsnam/ns-3-dev.git ns
RUN git clone https://gitlab.com/nsnam/ns-3-dev.git ns
WORKDIR /usr/ns
RUN git clone -b 5g-lena-v1.2.y https://<token-name:token>@gitlab.com/cttc-lena/nr.git contrib/nr
